...
Given the set of training images, you can hand-label examples of different colors by yourself using hand_label.py to circle the region of interest as training data. (But you need to download Roipoly first. URL:[https://github.com/jdoepfert/roipoly.py](URL))You can also use train_b.npy and train_nb.npy as training data.
